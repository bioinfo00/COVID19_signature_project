---
title: "Fig S2 - Stability analysis of solution space"
output: rmarkdown::github_document
---

Here we perform a global stability analysis of the solution space.
We define a stability value at the gene and solution levels.
At the gene level, stability is the frequency at which a given gene appears
in the solution space. At the solution (signature) level, stability is the mean
